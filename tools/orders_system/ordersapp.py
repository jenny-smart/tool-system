...
FUNCTION_OPTIONS = [
    ...
    ("舊客快速建單：電話查會員、帶入歷史資料建單；需求搜尋整合在此流程內。",
     "orders", "舊客快速建單"),
    ("新客資料拆解：貼上制式文字拆成欄位，供客服修改後複製，不直接送單。",
     "orders", "新客資料拆解"),
    ("儲值金購買：客人自行儲值／購買金額建單，付款方式與發票自動沿用會員最近一次設定。",
     "orders", "儲值金購買"),
    ...
    ("台北/台中區對帳：ATM 待付款清單查詢、配對銀行明細、更新系統對帳。",
     "memo", "台北/台中區對帳"),
    ("桃園/新竹對帳：依付款日期、付款狀態搜尋 ATM 訂單，寫入欄位並比對銀行明細，"
     "支援一筆匯款對多筆訂單。",
     "memo", "桃園/新竹對帳"),
